!(function (e, t) {
			...
			function (e, t) {
				_.fn[e] = function (n, i) {
					...
					return (
						...
						this.length > 1 &&
							(j[e] || _.uniqueSort(r), O.test(e) && r.reverse()),
						this.pushStack(r)
					);
				};
			}
	...
	function Oe(e, t) {
		...
		if (1 === t.nodeType) {
			...
			X.hasData(e) &&
				((a = X.access(e)), (l = _.extend({}, a)), X.set(t, l));
		}
	}
	function je(e, t) {
		var n = t.nodeName.toLowerCase();
	...
	function Le(e, t, n, i) {
		...
		if (
			...
			if (l)
				for (
					u = a[a.length - 1].ownerDocument, _.map(a, Ie), f = 0;
					f < l;
					f++
				)
					(c = a[f]),
						fe.test(c.type || "") &&
							...
							(c.src && "module" !== (c.type || "").toLowerCase()
								...
								: y(c.textContent.replace(De, ""), u, c));
		}
		return e;
	}
	function Pe(e, t, n) {
		for (var i, r = t ? _.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
			n || 1 !== i.nodeType || _.cleanData(de(i)),
				i.parentNode &&
					(n && _.contains(i.ownerDocument, i) && pe(de(i, "script")),
	...
	_.extend({
		...
		clone: function (e, t, n) {
			...
			if (t)
				if (n)
					for (
						o = o || de(e), s = s || de(a), i = 0, r = o.length;
						i < r;
						i++
					)
						Oe(o[i], s[i]);
		...
		_.fn.extend({
			...
			empty: function () {
				for (var e, t = 0; null != (e = this[t]); t++)
					1 === e.nodeType &&
						(_.cleanData(de(e, !1)), (e.textContent = ""));
				return this;
			},
			clone: function (e, t) {
				return (
	...
	_.extend({
		...
		_.each(["height", "width"], function (e, t) {
			_.cssHooks[t] = {
				get: function (e, n, i) {
					if (n)
						return !We.test(_.css(e, "display")) ||
	...
	function st(e, t, n) {
		...
		for (
			...
			if ((i = st.prefilters[o].call(c, e, u, c.opts)))
				return (
					g(i.stop) &&
						(_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(
							i
						)),
					i
				);
					...
					return void 0 === e.getAttribute
						...
						: ((1 === o && _.isXMLDoc(e)) ||
								(r =
									...
									(_.expr.match.bool.test(t) ? at : void 0)),
						  void 0 !== n
								? null === n
			...
			return arguments.length
				? ((i = g(e)),
				  this.each(function (n) {
						...
						1 === this.nodeType &&
							(null ==
							(r = i ? e.call(this, n, _(this).val()) : e)
								? (r = "")
								: "number" == typeof r
								? (r += "")
								: Array.isArray(r) &&
					...
					o ||
						...
						(u &&
							...
							t.isPropagationStopped() &&
								p.addEventListener(y, mt),
							r[y](),
							t.isPropagationStopped() &&
								p.removeEventListener(y, mt),
		...
		_.extend({
			...
			ajax: function (t, n) {
				...
				p.ifModified &&
					...
					_.etag[o] &&
						T.setRequestHeader("If-None-Match", _.etag[o])),
						...
						["scroll", "resize", "load"].forEach(function (e) {
							...
							window.MutationObserver &&
								addEventListener(
									"DOMContentLoaded",
									function () {
										new MutationObserver(n).observe(
											document.body,
											{
												attributes: !0,
												childList: !0,
