<?php include __DIR__ . "/partials/header.php"; ?>
    ...
    <form action="" method="post" class="form responsive-width-100">
        ...
        <input type="text" id="username" name="username" placeholder="Username" value="<?php echo $account[
        	"username"
        ]; ?>" required>
        
        <label for="email">Email</label>
        <input type="text" id="email" name="email" placeholder="Email" value="<?php echo $account[
        	"email"
        ]; ?>" required>
        <label for="fullname">Full name</label>
        <input type="text" id="fullname" name="fullname" placeholder="fullname" value="<?php echo $account[
        	"fullname"
        ]; ?>">
        
        <label for="description">Description</label>
        <input type="text" id="description" name="description" placeholder="description" value="<?php echo $account[
        	"description"
        ]; ?>">
