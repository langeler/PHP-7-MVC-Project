...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	...
	<div class="btn-toolbar mb-2 mb-md-0">
		<div class="btn-group mr-2">
			...
			<a href="/admin/category/image/create/<?= $pageData[
   	"cid"
		...
		<?php if ($pageData["images"]): ?>
			<table class='table table-hover table-responsive'>
				...
				<tr>
					...
					<td>
				    	<a class="btn btn-sm btn-primary" href="/admin/category/image/update/<?= strtolower(
         	$image["id"]
         ) ?>">
							Update
						</a>

						<a class="btn btn-sm btn-danger" href="/admin/category/image/delete/<?= strtolower(
      	$image["id"]
      ) ?>">
							Delete
						</a>
