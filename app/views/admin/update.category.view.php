<?php include __DIR__ . "/partials/header.php"; ?>
    ...
    <form action="" method="post" class="form responsive-width-100">
        ...
        <input type="text" id="name" name="name" placeholder="Name" value="<?php echo $category[
        	"name"
        ]; ?>">
        
        <label for="description">Description</label>
        <input type="text" id="description" name="description" placeholder="description" value="<?php echo $category[
        	"description"
        ]; ?>">
