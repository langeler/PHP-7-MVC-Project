...
class ProductImage extends Model
{
	...
	public function upload() {
		...
		foreach($_FILES['files']['tmp_name'] as $key => $value){
			...
			if (!isset($error) || is_array($error)) {
				$this->validate->errors[] = "Invalid upload parameter, error occured.";
				continue;
			}
			...
			if($this->validate->isSuccess()) {
				...
				$targetDirectory = UPLOAD_DIR . DS . $this->pid;
				...
				// New file path
				$newFilepath = $targetDirectory . DS . $filename . "." . $extension;
	...
	public function remove() {
		...
		// The name of the directory that we need to create.
		$filepath = UPLOAD_DIR . DS . $this->pid . DS . $this->name;
